...
function Guard() {
    ...
    const apiBase = `${import.meta.env.VITE_API_URL}/Alarms`;
                ...
                <table>
                    ...
                    <tbody>
                        {alarms.map((alarm) => {
                            ...
                            const fullImgUrl = getImageUrl(alarm);
                            return (
                                <tr key={alarm.alarmId || alarm.id}>
                                    ...
                                    <td>{renderAlarmMessage(alarm.message)}</td>
                                    <td>
                                        {fullImgUrl ? (
                                            <a
                                                href={fullImgUrl}
                                                ...
                                                className="view-snapshot-link"
                                            >
                                                👁
                                            </a>
                                        ) : (
                                            <span className="welcome-guest-text">Немає фото</span>
                                        )}
                                    </td>
